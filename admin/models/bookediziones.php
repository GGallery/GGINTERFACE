...
class gginterfaceModelbookediziones extends JModelList
{

    //Add this handy array with database fields to search in
    protected $searchInFields = array('titolo');
...
//Override construct to allow filtering and ordering on our fields
    ...
    protected function getListQuery()
    {
        ...
        // Select some fields
        $id_corso=JFactory::getApplication()->getUserState('id_corso');

        $query->select('*')
            ->from('#__ggif_bookedizioni')
