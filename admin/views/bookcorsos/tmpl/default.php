...
<div id="j-main-container" class="span10">
    ...
    <div class="span12">
        <form action="<?php echo JRoute::_('index.php?option=com_gginterface'); ?>" method="post" name="adminForm" id="adminForm">
            ...
            <div id="span10 j-toggle-main">
                        ...
                        <div class="js-stools-container-bar">
                            ...
                            <div class="js-stools-container-bar">
                                ...
                                <div class="btn-wrapper input-append">
                                    ...
                                    <input type="text" name="filter_search" id="filter_search" value="<?php echo $this->escape($this->searchterms); ?>" title="<?php echo "scrivi"; ?>" />
                ...
                <div>
                    <input type="hidden" name="view" value="bookcorsi" />
                    <input type="hidden" name="task" value="bookcorsi" />
