...
class gginterfaceViewbookedizione extends JViewLegacy {
    ...
    protected function addToolBar() {
        ...
        JToolBarHelper::title($isNew ? 'NUOVA EDIZIONE': 'MODIFICA EDIZIONE', 'bookedizione');
        JToolBarHelper::save('bookedizione.save');
        JToolBarHelper::apply('bookedizione.apply');
        JToolBarHelper::cancel('bookedizione.cancel', $isNew ? 'JTOOLBAR_CANCEL' : 'JTOOLBAR_CLOSE');
    }
