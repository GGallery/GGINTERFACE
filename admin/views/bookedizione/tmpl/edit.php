...
<form action="<?php echo JRoute::_('index.php?option=com_gginterface&view=bookedizione&layout=edit&id=' . (int) $this->item->id); ?>"
      method="post"
      name="adminForm"
      id="adminForm"
    ...
    <div class="row-fluid">
        <div class="span12">
            ...
            <div class="span4">
                ...
                <div class="row-fluid">
                    <?php echo $this->form->renderField('id_corso'); ?>
                </div>
