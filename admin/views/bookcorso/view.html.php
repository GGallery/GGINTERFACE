...
class gginterfaceViewbookcorso extends JViewLegacy {
    ...
    protected function addToolBar() {
        ...
        JToolBarHelper::title($isNew ? 'NUOVO CORSO': 'MODIFICA CORSO', 'bookcorso');
        JToolBarHelper::save('bookcorso.save');
        JToolBarHelper::apply('bookcorso.apply');
        JToolBarHelper::cancel('bookcorso.cancel', $isNew ? 'JTOOLBAR_CANCEL' : 'JTOOLBAR_CLOSE');
    }
