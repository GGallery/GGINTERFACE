...
<form action="<?php echo JRoute::_('index.php?option=com_gginterface'); ?>"
    ...
    <div class="row-fluid">
        <div class="span6">
            ...
            <input id="path" type="hidden" name="path" value="<?php echo $_SERVER['DOCUMENT_ROOT']; ?>/mediagg/attestati/esma/" size = "50px">
            <input id="subpath" type="hidden" name="subpath" value="" size = "50px">
            <input id="url" type="hidden" name="url" value="<?php echo $_SERVER['SERVER_NAME']; ?>/mediagg/attestati/esma/" size = "50px">
