 ...
 * @subpackage WebTV
 */
class gginterfaceModelContenuto extends JModelLegacy {
    ...
    public function getPropedeuticita(){
        if($this->prerequisiti) {
            foreach (explode(",", $this->prerequisiti) as $idprerequisito) {
                $model_prerequisito = new gginterfaceModelContenuto();
    ...
    public function getContenuto($id = null){
        ...
        try
        {
            ...
            $data = $this->_db->loadObject('gginterfaceModelContenuto');
    ...
    public function getUrlLink(){
        ...
        switch($this->tipologia){
            ...
            case 6: //Testuale HTML
                ...
                $url="index.php?option=com_gginterface&view=contenuto&alias=".$this->alias;
...
//		RESTITUISCO UN OGGETTO STATO
    ...
    private function getStato_SSO(){
        ...
        $stato = new gginterfaceModelStatoContenuto();
...
//            $tmp->varName = 'cmi.student_data.mastery_score';
//            $tmp->varValue = 100;
//            $stato->setStato($tmp);
//
...
//            $stato->setStato($tmp);
//
//            $tmp->varName = 'cmi.core.lesson_location';
//            $tmp->varValue = "";
//            $stato->setStato($tmp);
        }

        // FINE CONTROLLO SCORM CARIGE ---------------------------
