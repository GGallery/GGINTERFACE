...
class utilityHelper {
    ...
    public static function getgginterfaceParam() {
        try {
    ...
    public static function setComponentParam($key, $value)    {
        ...
        $params = JComponentHelper::getParams('com_gginterface');
        $params->set($key, $value);

        $componentid = JComponentHelper::getComponent('com_gginterface')->id;
